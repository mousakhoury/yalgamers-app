...
<div
	class="h-[303.421px] lg:h-[344px] w-[229.33px] lg:w-[260px] duration-300 rounded-[9px] p-[1px] relative overflow-hidden cardBG group hover:scale-105 block"
>
	<div
	...
	>
		<div class="relative overflow-hidden rounded-[4px]">
			<img
				src={courseImageUrl}
				alt=""
				class="w-[220.51px] lg:w-[250px] h-[294.016px] lg:h-[333.337px] rounded-[4px] object-cover"
			/>
			<div
				class="flex flex-col items-start justify-between absolute w-full h-full top-0 left-0 pt-[7px] lg:pt-[8px] pb-[11px] z-20"
			>
				<div class="flex flex-col items-start gap-[7px] lg:gap-[8px]">
					<div
						class="flex items-center gap-[5.292px] lg:gap-[6px] h-[24.6px] lg:h-[28px] py-[5.292px] lg:py-[6px] px-[8.82px] lg:px-[10px] border border-[#ffffff33] bg-[#792341] {$locale ===
						'ar'
							? 'rounded-l-[100px] border-r-0'
							: 'rounded-r-[100px] border-l-0'}"
					>
						<img src={calendar} alt="" class="w-[14.113px] lg:w-[16px]" />
						<p class="text-[#FFFFFFE5] text-[12.349px] lg:text-[14px] font-Gilroy-Medium">
							{processedDeadline}
						</p>
					</div>
					...
					<div
						class="flex items-center gap-[5.292px] lg:gap-[6px] h-[24.6px] lg:h-[28px] py-[5.292px] lg:py-[6px] px-[8.82px] lg:px-[10px] border border-[#8EC9ED] bg-[#1C272D] {$locale ===
						'ar'
							? 'rounded-l-[100px] border-r-0'
							: 'rounded-r-[100px] border-l-0'}"
					>
						<p class="text-[#8EC9ED] text-[12.349px] lg:text-[14px] font-Gilroy-Medium">
							{$t('New')}!
						</p>
					</div>
				</div>
			...
			<div
				class="absolute w-[220px] lg:w-[260px] h-[296px] lg:h-[240px] lg:group-hover:h-[357px] duration-300 bottom-0 left-0 gradient-bg z-10"
			/>
			<div
				class="flex flex-col items-start justify-end gap-[10.584px] lg:gap-[12.462px] absolute w-[218.16px] lg:w-[245.077px] h-[196px] lg:h-[223px] p-[9px] lg:p-[12px] pb-[52px] lg:pb-[57px] duration-300 bottom-0 lg:bottom-[-105px] lg:group-hover:bottom-0 left-0 z-30"
			>
				<p class="text-[#E9E6EA] text-[17.641px] lg:text-[20.769px] font-Gilroy-SemiBold">
					{$locale === 'en' ? tournament.title_en : tournament.title}
				</p>
				<div
					class="flex flex-col items-start gap-[6.795px] lg:gap-[8px] lg:opacity-0 lg:group-hover:opacity-100"
				>
					<div class="flex flex-col items-start gap-[3.528px] lg:gap-[4px]">
						<p class="color-text text-[10.584px] lg:text-[12.462px] font-Gilroy">
							{$t('prizeMoney')}
						</p>
						<div class="flex items-center gap-[5.292px] lg:gap-[6px]">
							<p class="text-[#FFFFFFB2] text-[14.113px] lg:text-[16.615px] font-Gilroy-Medium">
								{tournament.price}
								{$t('usd')}
							</p>
							<img src={dollarCircle} alt="" class="w-[15.877px] lg:w-[18.692px]" />
						</div>
					</div>
					<hr class="w-full border-[#FFFFFF0D]" />
					<div class="flex flex-col items-start gap-[3.528px] lg:gap-[4px]">
						<p class="text-[#8EC9ED] text-[10.584px] lg:text-[12.462px] font-Gilroy">
							{$t('game mode')}
						</p>
						<div class="flex items-center gap-[5.292px] lg:gap-[6px]">
							<p class="text-[#FFFFFFB2] text-[14.113px] lg:text-[16.615px] font-Gilroy-Medium">
							...
							<img src={Squad} alt="" class="w-[15.877px] lg:w-[18.692px]" />
						</div>
					</div>
				</div>
			</div>
			<div class=" absolute bottom-0 left-0 p-[9px] lg:p-[12px] w-full z-40">
				<a
					href={`/tournaments/${tournament.id}`}
					class="flex items-center justify-center gap-[4px] w-full h-[31.7px] lg:h-[36px] gradient-color-bg"
				>
					<p class="text-[#23130D] text-[12.349px] lg:text-[14px] font-Gilroy-Medium">
						{$t('enrollNow')}
					</p>
				</a>
			</div>
