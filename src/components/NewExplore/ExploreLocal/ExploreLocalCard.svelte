...
<a
	...
	class="h-[198.919px] lg:h-[276px] w-[320px] lg:w-[444px] duration-300 rounded-[9px] p-[1px] relative overflow-hidden cardBG group block"
>
	<div
	...
	>
		<div class="relative">
			<img
				src={courseImageUrl}
				alt=""
				class="w-[144.144px] lg:w-[200px] h-[191.657px] lg:h-[265.924px] rounded-[4px] object-cover"
			/>
			<div
		...
		<div class="flex flex-col items-start gap-[12.15px] lg:gap-[16px] w-[146.306px] lg:w-[203px]">
