...
<div class={`rank shrink-0 ${newClass} ${rankClass(rank)}`}>
	<div class="rank-name">
		...
		<p class="text-[#D4CFD6] text-[16px] font-Gilroy-SemiBold w-[148px]">
			{name} <span class="text-[#948798] text-[14px] font-Gilroy">{isMe ? '(Me)' : ''}</span>
		</p>
		<p class="text-[#D4CFD6] text-[16px] font-Gilroy-SemiBold w-[138px]">{username}</p>
	</div>
